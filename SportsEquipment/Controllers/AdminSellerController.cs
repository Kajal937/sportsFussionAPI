...
namespace SportsEquipment.Services
{
    ...
    public class AdminSellerController : ControllerBase
    {
        ...
        //[HttpPost("seller")]
        [HttpPost("seller")]
        public async Task<IActionResult> AddSeller([FromBody] AdminSeller adminSeller, string productName)
        {

            await _adminSellerService.AddSellerAsync(adminSeller, productName);
            return Ok();
        }
